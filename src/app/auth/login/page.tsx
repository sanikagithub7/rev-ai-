...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen swiss-grid-bg flex items-center justify-center p-6 text-black">
      <div className="w-full max-w-md bg-white sharp-border p-8 relative">
        {/* Color accent block behind header */}
        <div className="w-full h-3 bg-[#12B76A] mb-6" />
        ...
        <p className="text-xs text-neutral-600 mb-6">
          Enter your organization email to access your AI Sales Autopilot workspace.
        </p>
        ...
        <div className="mt-8 pt-6 border-t border-neutral-200 flex items-center justify-between text-xs">
          ...
          <Link href="/auth/signup" className="font-bold uppercase tracking-wider text-black hover:text-[#12B76A]">
            Create Workspace →
          </Link>
        </div>
